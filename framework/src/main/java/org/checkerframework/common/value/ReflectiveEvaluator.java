...
public class ReflectiveEvaluator {
  ...
  public Object evaluateStaticFieldAccess(
    ...
    try {
      ...
      // TODO: Should this catch, and the field.access.failed.unusual message, be removed, and the
      // functionality be changed in the final catch block?
      if (reportWarnings) {
        checker.reportWarning(
            tree,
            "field.access.failed.unusual",
            fieldName,
            classname,
