...
class ValueTreeAnnotator extends TreeAnnotator {
  ...
  /**
   * Given a call to {@code Math.min} or {@code Math.max} method, returns the Range of the result.
   * Returns null if the argument is none of these methods or their arguments are not annotated in
   * ValueChecker hierarchy.
   *
