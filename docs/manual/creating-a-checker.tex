...
\refmethod{framework/type}{GenericAnnotatedTypeFactory}{createDependentTypesHelperForContracts}{--}
...
%  LocalWords:  createDependentTypesHelperForContracts boolean regex subclasses README
