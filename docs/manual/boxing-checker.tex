...
\item[\refqualclass{checker/boxing/qual}{RefCollection}]
...
\item[\refqualclass{checker/boxing/qual}{PrimCollection}]
...
% LocalWords:  unboxing RefCollection PrimCollection
% LocalWords:  UnknownRepCollection CollectionRepBottom
