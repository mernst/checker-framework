...
\caption{Partial type hierarchy for the Signature type system, showing
  ...
  Programmers primarily write
  the boldfaced qualifiers.  The other qualifiers (and some
  \href{https://checkerframework.org/api/org/checkerframework/checker/signature/qual/package-summary.html}{not
  shown}) are
  included to handle other strings and to improve the internal handling of
  String literals.}
...
The Signature Checker also supports other qualifiers such as
\refqualclass{checker/signature/qual}{PackageName} and
\refqualclass{checker/signature/qual}{ModuleName}, which you may wish to
use.  See the
\href{https://checkerframework.org/api/org/checkerframework/checker/signature/qual/package-summary.html}{list
of Signature Checker qualifiers}.
